...
int main(int argc, char **argv) { 
    ...
    std::vector<std::vector<double>> lightDirections; // light directions
    lightDirections.push_back(lightDirection(sphere1, circlex, circley, circleRadius)); // light direction 1
    lightDirections.push_back(lightDirection(sphere2, circlex, circley, circleRadius)); // light direction 2
    lightDirections.push_back(lightDirection(sphere3, circlex, circley, circleRadius)); // light direction 3
    ...
    for (auto x : lightDirections){ // for each light direction
